"""Scrape Stinson listings from Barnstormers.com and render them into
...
PAGE_TITLE = "Other Stinson Ads on the Web"
...
EXTERNAL_SEARCH_LINKS = [
    (
        "Trade-A-Plane",
        "https://www.trade-a-plane.com/filtered/search?s-type=aircraft&s-keyword-search=stinson&s-original-search=stinson",
    ),
    ("Controller", "https://www.controller.com/listings?keywords=stinson"),
    ("ASO", "https://aso.com/search?q=Stinson"),
]
...
<body>
  ...
  <div class="more-resources">
    <h2>Search More Stinson Listings</h2>
    <p>View additional Stinson Aircraft listings at these fine sites:</p>
